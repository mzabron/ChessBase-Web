...
namespace ChessBase.Infrastructure.Migrations
{
    ...
    [Migration("20260318185037_AddStagingArea")]
    partial class AddStagingArea
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.Move", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.Player", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.Position", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.StagingGame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerUserId", "ImportSessionId", "Black");

                    b.HasIndex("OwnerUserId", "ImportSessionId", "GameHash");

                    b.HasIndex("OwnerUserId", "ImportSessionId", "White");

                    b.ToTable("StagingGames");
                });

            modelBuilder.Entity("ChessBase.Domain.Entities.StagingImportSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("StagingImportSessions");
                });

            modelBuilder.Entity("ChessBase.Domain.Entities.StagingMove", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.StagingPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.UserDatabase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.UserDatabaseGame", b =>
                {
            ...
            modelBuilder.Entity("ChessBase.Infrastructure.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.Game", b =>
                {
                    b.HasOne("ChessBase.Domain.Entities.Player", "BlackPlayer")
                        .WithMany("GamesAsBlack")
                        .HasForeignKey("BlackPlayerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ChessBase.Domain.Entities.Player", "WhitePlayer")
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.Move", b =>
                {
                    b.HasOne("ChessBase.Domain.Entities.Game", "Game")
                        .WithMany("Moves")
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.StagingGame", b =>
                {
                    b.HasOne("ChessBase.Domain.Entities.StagingImportSession", "ImportSession")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.StagingImportSession", b =>
                {
                    b.HasOne("ChessBase.Infrastructure.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.StagingMove", b =>
                {
                    b.HasOne("ChessBase.Domain.Entities.StagingGame", "Game")
                        .WithMany("Moves")
            ...
            modelBuilder.Entity("ChessBase.Domain.Entities.UserDatabaseGame", b =>
                {
                    ...
                    b.HasOne("ChessBase.Domain.Entities.UserDatabase", "UserDatabase")
                        .WithMany("UserDatabaseGames")
