...
internal static class PgnServiceTestData
{
    ...
    private static string FindProjectRoot()
    {
        ...
        {
            var csproj = Path.Combine(current.FullName, "ChessBase.UnitTests.csproj");
        ...
        throw new DirectoryNotFoundException("Could not locate ChessBase.UnitTests project root.");
    }
}
