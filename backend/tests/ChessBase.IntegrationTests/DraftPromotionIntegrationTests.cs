...
public class DraftPromotionIntegrationTests(PostgresTestFixture fixture)
{
    ...
    private static DraftImportService CreateDraftImportService(ChessBaseDbContext dbContext)
    {
    ...
    private static DraftPromotionService CreateDraftPromotionService(ChessBaseDbContext dbContext, IUnitOfWork unitOfWork)
    {
    ...
    private static async Task<(string OwnerId, Guid UserDatabaseId)> CreateOwnerAndDatabaseAsync(ChessBaseDbContext dbContext, string ownerId)
    {
    ...
    private sealed class CountingUnitOfWork(ChessBaseDbContext dbContext) : IUnitOfWork
    {
